...
<body>
    ...
    <div class="container-fluid m-4 pt-5 ">
        <div class="row">
            ...
            <div class="bg-dar col-12 col-md-4">
                <div class="card">
                    <div class="card-body">
                        <!--#encabezado-floating-panel-1-->
                        <div id="encabezado-floating-pane">
                            ...
                            <form method="post" id="formulario-ubicacion-actual">
                                ...
                                <input class="btn btn-primary" type="submit" name="buscaRutas" id="buscaRutas" value="Busca rutas!">
                            </form><br>
                            <button class="btn btn-primary" id='trazar' disabled="true">trazar!</button>&ensp;&ensp;
                            <button class="btn btn-primary" onclick="reiniciarMapa()">Reinicia mapa</button>&ensp;&ensp;
                            <button class="btn btn-primary" onclick="encuentrame()">Encuéntrame</button>&ensp;&ensp;
                            <button class="btn btn-primary" onclick="personalizaPolylinea()">Personaliza</button><br><br>
                            
                        </div>                    <!--#encabezado-floating-panel-1-->
                        <div id="encabezado-floating-pane">
                            <h2>Usuario Viajero</h2>
                            <p>Bienvenido, <?php echo "Andrés" ?>.</p>
                            <br>
